        ...
        <div className='flex flex-col items-center gap-2 text-gray-100 my-5' id='Contact'>
            ...
            <form onSubmit={onSubmit}>
                <div className='flex flex-col items-center gap-5'>
                    ...
                    <button onClick={() => {navigate('/'); scrollTo(0,0)}} className='border rounded-full h-[40px] w-[300px] md:w-[510px] bg-yellow-300 text-black font-bold cursor-pointer hover:bg-yellow-200 transition-all duration-500'>{result ? result : "Send"}</button>
                </div>
            </form>
        </div>
    )
